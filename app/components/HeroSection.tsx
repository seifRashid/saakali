    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        "radial-gradient(ellipse at 30% 40%, rgba(201,168,76,0.15) 0%, transparent 60%), radial-gradient(ellipse at 70% 60%, rgba(201,168,76,0.1) 0%, transparent 50%)",
                }}
            />
            ...
            <motion.div
                ...
                className="absolute top-[15%] right-[8%] w-56 h-56 rounded-full border border-gold/10 hidden lg:block"
            />
            <motion.div
            ...
            <motion.div
                ...
                className="absolute right-[5%] top-1/2 -translate-y-1/2 w-[280px] h-[280px] md:w-[380px] md:h-[380px] lg:w-[450px] lg:h-[450px] hidden md:block"
            >
                <motion.div
                    animate={{ y: [-10, 10, -10] }}
            ...
            {/* Content */}
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full flex flex-col justify-center h-full">
                <div className="max-w-2xl">
                    ...
                    >
                        <a href="#bestsellers" className="btn-primary text-center justify-center px-8 py-3 text-sm">
